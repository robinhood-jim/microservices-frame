package com.robin.oauth2.tokenstore;
...
public class RedisTokenStorePatched implements TokenStore {
    ...
    public RedisTokenStorePatched(RedisConnectionFactory connectionFactory) {
